...
/**
 * Enhanced Agent Helper CLI Tool
 * A comprehensive command-line tool for agents to manage Shopify store data
 * 
 * Usage:
 *   node enhanced-agent-tool.js [command] [options]
 * 
 * Commands:
...
EXAMPLES:
  node enhanced-agent-tool.js info
  node enhanced-agent-tool.js products --list --limit 20
  node enhanced-agent-tool.js products --search "coffee"
  node enhanced-agent-tool.js inventory --low-stock
  node enhanced-agent-tool.js orders --list --status unfulfilled
  node enhanced-agent-tool.js customers --search "john@example.com"
  node enhanced-agent-tool.js reports --sales 7
  node enhanced-agent-tool.js export --products my-products.csv
  node enhanced-agent-tool.js health
